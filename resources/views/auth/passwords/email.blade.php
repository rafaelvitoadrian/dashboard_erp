                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6">
                        <div class="card-body pt-5">
                            <form method="POST" action="{{ route('password.email') }}" class="row sign-up-form form g-3">
                                @csrf
                                <div class="col-md-12 text-center">
                                    <h3>Forgot Your Password?</h3>
                                </div>
                                <div class="col-md-12 text-center">
                                    <p>Enter your email verification for verification code to reset your password</p>
                                </div>
                                <div class="col-md-12">
