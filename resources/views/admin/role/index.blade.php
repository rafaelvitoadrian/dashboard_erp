          ...
          <nav aria-label="breadcrumb">
            ...
            <ol class="breadcrumb my-0 ms-2 mb-2">
              <form method="GET" class="row row-cols-lg-auto g-3 align-items-center">
                ...
                <div class="col-12">
                    <a href="{{route('role.create')}}" class="btn btn-primary btn-md"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 17">
                ...
                <tr >
                  ...
                  <td class="text-center">
                    <form action="{{route ('role.destroy', $r->id)  }}" method="POST">
                        @can('Roles edit')
                            <a href="{{ route ('role.edit', $r->id) }}" class="btn btn-primary mr-1 mb-1"> <svg class="action-icon">
